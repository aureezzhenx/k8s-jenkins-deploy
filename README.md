...
- Masing-masing Pod akan mengirim informasi penggunaan Resource Hardware ke services Metrics Server sebagai Parameter Trigger Horizontal Pod AutoScaller
